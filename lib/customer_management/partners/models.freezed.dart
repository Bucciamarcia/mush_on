...
/// ALSO stored as a field in the doc (never rely on doc.id alone).
 ...
 int get deferredDays;/// Never delete partners — archive for stats/recovery.
 bool get archived;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,code,email,discountRate,allowDeferred,deferredDays,archived);

@override
String toString() {
  return 'Partner(id: $id, name: $name, code: $code, email: $email, discountRate: $discountRate, allowDeferred: $allowDeferred, deferredDays: $deferredDays, archived: $archived)';
}
...
@useResult
$Res call({
 String id, String name, String code, String? email, double? discountRate, bool allowDeferred, int deferredDays, bool archived
});
...
/// Create a copy of Partner
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? code = null,Object? email = freezed,Object? discountRate = freezed,Object? allowDeferred = null,Object? deferredDays = null,Object? archived = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String code,  String? email,  double? discountRate,  bool allowDeferred,  int deferredDays,  bool archived)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Partner() when $default != null:
return $default(_that.id,_that.name,_that.code,_that.email,_that.discountRate,_that.allowDeferred,_that.deferredDays,_that.archived);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String code,  String? email,  double? discountRate,  bool allowDeferred,  int deferredDays,  bool archived)  $default,) {final _that = this;
switch (_that) {
case _Partner():
return $default(_that.id,_that.name,_that.code,_that.email,_that.discountRate,_that.allowDeferred,_that.deferredDays,_that.archived);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String code,  String? email,  double? discountRate,  bool allowDeferred,  int deferredDays,  bool archived)?  $default,) {final _that = this;
switch (_that) {
case _Partner() when $default != null:
return $default(_that.id,_that.name,_that.code,_that.email,_that.discountRate,_that.allowDeferred,_that.deferredDays,_that.archived);case _:
  return null;
...
class _Partner implements Partner {
  const _Partner({required this.id, this.name = "", this.code = "", this.email, this.discountRate, this.allowDeferred = false, this.deferredDays = 0, this.archived = false});
...
/// Create a copy of Partner
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? code = null,Object? email = freezed,Object? discountRate = freezed,Object? allowDeferred = null,Object? deferredDays = null,Object? archived = null,}) {
