...
extension HomePageRiverpodResultsPatterns on HomePageRiverpodResults {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_HomePageRiverpodResults value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _HomePageRiverpodResults() when $default != null:
        return $default(_that.dogs, _that.tasks, _that.heatCycles,
            _that.healthEvents, _that.whiteboardElements);
      case _:
        return orElse();
    }
  }
...
extension WhiteboardElementPatterns on WhiteboardElement {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_WhiteboardElement value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _WhiteboardElement() when $default != null:
        return $default(_that.id, _that.title, _that.description, _that.date,
            _that.author, _that.comments);
      case _:
        return orElse();
    }
  }
...
extension WhiteboardElementCommentPatterns on WhiteboardElementComment {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_WhiteboardElementComment value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String comment, String? author,
            @NonNullableTimestampConverter() DateTime date)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _WhiteboardElementComment() when $default != null:
        return $default(_that.comment, _that.author, _that.date);
      case _:
        return orElse();
    }
  }
