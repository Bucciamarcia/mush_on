...
mixin _$BookingCustomField implements DiagnosticableTreeMixin {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $BookingCustomFieldCopyWith<BookingCustomField> get copyWith =>
      _$BookingCustomFieldCopyWithImpl<BookingCustomField>(
          this as BookingCustomField, _$identity);
...
abstract mixin class $BookingCustomFieldCopyWith<$Res> {
  factory $BookingCustomFieldCopyWith(
          BookingCustomField value, $Res Function(BookingCustomField) _then) =
      _$BookingCustomFieldCopyWithImpl;
  @useResult
  $Res call(
      {String id,
      CustomerCustomFieldType type,
...
extension BookingCustomFieldPatterns on BookingCustomField {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_BookingCustomField value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
/// @nodoc
@JsonSerializable()
class _BookingCustomField
    with DiagnosticableTreeMixin
    implements BookingCustomField {
  const _BookingCustomField(
      {required this.id,
      required this.type,
      required this.name,
      required this.description,
      required this.isRequired});
  factory _BookingCustomField.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$BookingCustomFieldCopyWith<_BookingCustomField> get copyWith =>
      __$BookingCustomFieldCopyWithImpl<_BookingCustomField>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$BookingCustomFieldToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$BookingCustomFieldCopyWith<$Res>
    implements $BookingCustomFieldCopyWith<$Res> {
  factory _$BookingCustomFieldCopyWith(
          _BookingCustomField value, $Res Function(_BookingCustomField) _then) =
      __$BookingCustomFieldCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
