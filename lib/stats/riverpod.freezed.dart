...
$DateRangeSelectionCopyWith<DateRangeSelection> get copyWith => _$DateRangeSelectionCopyWithImpl<DateRangeSelection>(this as DateRangeSelection, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DateRangeSelection&&(identical(other.start, start) || other.start == start)&&(identical(other.end, end) || other.end == end));
}
...
abstract mixin class $DateRangeSelectionCopyWith<$Res>  {
  factory $DateRangeSelectionCopyWith(DateRangeSelection value, $Res Function(DateRangeSelection) _then) = _$DateRangeSelectionCopyWithImpl;
@useResult
$Res call({
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _DateRangeSelection value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _DateRangeSelection value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _DateRangeSelection value)?  $default,){
final _that = this;
switch (_that) {
case _DateRangeSelection() when $default != null:
return $default(_that);case _:
...
@pragma('vm:prefer-inline')
_$DateRangeSelectionCopyWith<_DateRangeSelection> get copyWith => __$DateRangeSelectionCopyWithImpl<_DateRangeSelection>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _DateRangeSelection&&(identical(other.start, start) || other.start == start)&&(identical(other.end, end) || other.end == end));
}
...
/// @nodoc
abstract mixin class _$DateRangeSelectionCopyWith<$Res> implements $DateRangeSelectionCopyWith<$Res> {
  factory _$DateRangeSelectionCopyWith(_DateRangeSelection value, $Res Function(_DateRangeSelection) _then) = __$DateRangeSelectionCopyWithImpl;
@override @useResult
$Res call({
 DateTime start, DateTime end
});
