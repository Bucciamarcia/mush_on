...
_HealthEvent _$HealthEventFromJson(Map<String, dynamic> json) => _HealthEvent(
  ...
  lastUpdated: const NonNullableTimestampConverter().fromJson(
    json['lastUpdated'] as Timestamp,
  ),
  title: json['title'] as String,
  date: DateTime.parse(json['date'] as String),
  resolvedDate: const TimestampConverter().fromJson(
    json['resolvedDate'] as Timestamp?,
  ),
...
Map<String, dynamic> _$HealthEventToJson(
  _HealthEvent instance,
) => <String, dynamic>{
  'id': instance.id,
  'dogId': instance.dogId,
  'createdAt': const NonNullableTimestampConverter().toJson(instance.createdAt),
  'lastUpdated': const NonNullableTimestampConverter().toJson(
...
_Vaccination _$VaccinationFromJson(Map<String, dynamic> json) => _Vaccination(
  ...
  dateAdministered: const NonNullableTimestampConverter().fromJson(
    json['dateAdministered'] as Timestamp,
  ),
  expirationDate: const TimestampConverter().fromJson(
    json['expirationDate'] as Timestamp?,
  ),
  documentIds:
      (json['documentIds'] as List<dynamic>?)
          ?.map((e) => e as String)
...
Map<String, dynamic> _$VaccinationToJson(
  ...
  'dateAdministered': const NonNullableTimestampConverter().toJson(
...
_HeatCycle _$HeatCycleFromJson(Map<String, dynamic> json) => _HeatCycle(
  ...
  dogId: json['dogId'] as String,
  notes: json['notes'] as String? ?? "",
  startDate: const NonNullableTimestampConverter().fromJson(
...
Map<String, dynamic> _$HeatCycleToJson(
  _HeatCycle instance,
) => <String, dynamic>{
  'id': instance.id,
  'dogId': instance.dogId,
  'notes': instance.notes,
  'startDate': const NonNullableTimestampConverter().toJson(instance.startDate),
  'createdAt': const NonNullableTimestampConverter().toJson(instance.createdAt),
  'lastUpdated': const NonNullableTimestampConverter().toJson(
    instance.lastUpdated,
  ),
