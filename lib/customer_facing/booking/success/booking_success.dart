...
class BookingConfirmationDataPage extends StatelessWidget {
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          const Text("Here's the information for your tour:"),
          const Text(
            "Date and time",
            style: TextStyle(fontSize: 20),
          ),
          Text(DateFormat("dd-MM-yyyy: hh:mm").format(cg.datetime)),
        ],
      ),
    );
  }
