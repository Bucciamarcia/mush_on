...
extension DogPositionsPatterns on DogPositions {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_DogPositions value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(bool lead, bool swing, bool team, bool wheel)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _DogPositions() when $default != null:
        return $default(_that.lead, _that.swing, _that.team, _that.wheel);
      case _:
        return orElse();
    }
  }
...
extension TagPatterns on Tag {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _Tag() when $default != null:
        return $default(_that.id, _that.name, _that.preventFromRun,
            _that.showInTeamBuilder, _that.created, _that.color, _that.expired);
      case _:
        return orElse();
    }
  }
